...
Un dataset es un conjunto de datos que se utilizan para entrenar un modelo de machine learning. En este caso, el dataset que se utilizó fue completamente recolectado por nosotros mismos, el cual consiste en imagenes de frutos pequeños en diferentes entornos; el dataset se compone de 1 sola clase, la cual es la de frutos. La cantidad de imagenes recolectada fue de 38 imagenes, pero realizando aumentacion de datos se logro aumentar a 114 imagenes guardadas en roboflow\cite{} para su uso en el entrenamiento del modelo.
